...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        ...
        db.session.add(u1)  # pylint: disable=no-member
        db.session.add(u2)  # pylint: disable=no-member
    ...
    def test_followed_posts(self):
        ...
        db.session.add_all([u1, u2, u3, u4])  # pylint: disable=no-member
        ...
        db.session.add_all([p1, p2, p3, p4])  # pylint: disable=no-member
        db.session.commit()  # pylint: disable=no-member
